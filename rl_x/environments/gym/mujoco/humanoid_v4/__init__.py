...
from rl_x.environments.gym.mujoco.humanoid_v4.create_env import create_train_and_eval_env
...
register_environment(GYM_MUJOCO_HUMANOID_V4, get_config, create_train_and_eval_env, GeneralProperties)
