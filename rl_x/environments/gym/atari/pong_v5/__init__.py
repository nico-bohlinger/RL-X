...
from rl_x.environments.gym.atari.pong_v5.create_env import create_train_and_eval_env
...
register_environment(GYM_ATARI_PONG_V5, get_config, create_train_and_eval_env, GeneralProperties)
