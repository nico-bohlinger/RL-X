...
from rl_x.environments.custom_interface.prototype.create_env import create_train_and_eval_env
...
register_environment(CUSTOM_ENVIRONMENT_PROTOTYPE, get_config, create_train_and_eval_env, GeneralProperties)
