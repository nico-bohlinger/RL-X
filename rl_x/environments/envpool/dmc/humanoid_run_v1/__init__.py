...
from rl_x.environments.envpool.dmc.humanoid_run_v1.create_env import create_train_and_eval_env
...
register_environment(ENVPOOL_DMC_HUMANOID_RUN_V1, get_config, create_train_and_eval_env, GeneralProperties)
