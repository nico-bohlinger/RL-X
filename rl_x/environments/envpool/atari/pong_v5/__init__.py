...
from rl_x.environments.envpool.atari.pong_v5.general_properties import GeneralProperties


ENVPOOL_ATARI_PONG_V5 = extract_environment_name_from_file(__file__)
register_environment(ENVPOOL_ATARI_PONG_V5, get_config, create_env, GeneralProperties)
