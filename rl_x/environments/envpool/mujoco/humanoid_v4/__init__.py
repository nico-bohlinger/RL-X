...
from rl_x.environments.envpool.mujoco.humanoid_v4.create_env import create_train_and_eval_env
...
register_environment(ENVPOOL_MUJOCO_HUMANOID_V4, get_config, create_train_and_eval_env, GeneralProperties)
