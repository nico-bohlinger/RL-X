...
from rl_x.environments.custom_mujoco.robot_motion_tracking.mjx_warp.environment import MotionTrackingEnv
from rl_x.environments.custom_mujoco.robot_motion_tracking.mjx_warp.general_properties import GeneralProperties
...
def create_train_and_eval_env(config):
    ...
    eval_env = MotionTrackingEnv(
        robot_config=robot_config,
        runner_mode=config.runner.mode,
        render=config.environment.render,
        env_config=config.environment,
        nr_envs=config.environment.evaluation_nr_envs,
    )
