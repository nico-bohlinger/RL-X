...
The robot locomotion example is a more complex environment and contains everything that is needed to train a quadruped (Unitree Go2 or MAB Silver Badger) or humanoid (Unitree G1) robot to walk and afterwards deploy the learned policy on the real robot.
