...
from rl_x.algorithms.tqc_elu.flax.policy import get_policy
from rl_x.algorithms.tqc_elu.flax.critic import get_critic
from rl_x.algorithms.tqc_elu.flax.entropy_coefficient import EntropyCoefficient, ConstantEntropyCoefficient
from rl_x.algorithms.tqc_elu.flax.replay_buffer import ReplayBuffer
from rl_x.algorithms.tqc_elu.flax.rl_train_state import RLTrainState
...
class TQC_ELU():
    ...
    def load(config, env, run_path, writer):
        ...
        model = TQC_ELU(config, env, run_path, writer)
