...
from rl_x.algorithms.tqc_tanhinitfix.flax.policy import get_policy
from rl_x.algorithms.tqc_tanhinitfix.flax.critic import get_critic
from rl_x.algorithms.tqc_tanhinitfix.flax.entropy_coefficient import EntropyCoefficient, ConstantEntropyCoefficient
from rl_x.algorithms.tqc_tanhinitfix.flax.replay_buffer import ReplayBuffer
from rl_x.algorithms.tqc_tanhinitfix.flax.rl_train_state import RLTrainState

rlx_logger = logging.getLogger("rl_x")


class TQC_TanhInitFix():
    ...
    def load(config, env, run_path, writer):
        ...
        model = TQC_TanhInitFix(config, env, run_path, writer)
