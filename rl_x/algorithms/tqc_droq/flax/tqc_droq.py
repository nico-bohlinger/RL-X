...
from rl_x.algorithms.tqc_droq.flax.policy import get_policy
from rl_x.algorithms.tqc_droq.flax.critic import get_critic
from rl_x.algorithms.tqc_droq.flax.entropy_coefficient import EntropyCoefficient, ConstantEntropyCoefficient
from rl_x.algorithms.tqc_droq.flax.replay_buffer import ReplayBuffer
from rl_x.algorithms.tqc_droq.flax.rl_train_state import RLTrainState
...
class TQC_DroQ():
    ...
    def load(config, env, run_path, writer):
        ...
        model = TQC_DroQ(config, env, run_path, writer)
