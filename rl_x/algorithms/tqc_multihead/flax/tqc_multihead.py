...
from rl_x.algorithms.tqc_multihead.flax.policy import get_policy
from rl_x.algorithms.tqc_multihead.flax.critic import get_critic
from rl_x.algorithms.tqc_multihead.flax.entropy_coefficient import EntropyCoefficient, ConstantEntropyCoefficient
from rl_x.algorithms.tqc_multihead.flax.replay_buffer import ReplayBuffer
from rl_x.algorithms.tqc_multihead.flax.rl_train_state import RLTrainState
...
class TQC_MultiHead():
    def __init__(self, config, env, run_path, writer) -> None:
        ...
        self.nr_total_atoms = self.nr_atoms_per_net * self.ensemble_size * config.algorithm.nr_heads_per_net
    ...
    def load(config, env, run_path, writer):
        ...
        model = TQC_MultiHead(config, env, run_path, writer)
