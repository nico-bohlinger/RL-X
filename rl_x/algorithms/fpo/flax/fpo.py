...
from rl_x.algorithms.fpo.flax.policy import get_policy
from rl_x.algorithms.fpo.flax.critic import get_critic
from rl_x.algorithms.fpo.flax import observation_normalizer
...
class FPO:
    ...
    def train(self):
        ...
        @jax.jit
        def update(policy_state, critic_state, states, actions, advantages, returns, epsilon, timestep, initial_statistic, key):
        ...
        while global_step < self.total_timesteps:
            ...
            epsilon = np.zeros((self.nr_steps, self.nr_envs, self.nr_flow_samples_per_action) + self.as_shape, dtype=np.float32)
