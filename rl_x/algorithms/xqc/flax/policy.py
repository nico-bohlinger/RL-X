...
class Policy(nn.Module):
    ...
    def __call__(self, x, train):
        ...
        mean = nn.Dense(self.action_dim, use_bias=True, kernel_init=default_kernel_init(), name="mean")(x)
        log_std = nn.Dense(self.action_dim, use_bias=True, kernel_init=default_kernel_init(scale=1.0), name="log_std")(x)
