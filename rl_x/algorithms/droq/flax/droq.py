    ...
    def train(self):
        ...
        def update(
            ...
            for i in range(self.q_update_steps):
                ...
                (loss, (metrics)), (critic_gradients) = grad_critic_loss_fn(critic_state.params, m_target_params, states[i], next_states[i], actions[i], rewards[i], dones[i], keys1, keys2, keys3)
