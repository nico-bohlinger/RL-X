...
from rl_x.algorithms.tqc_retrace.flax.policy import get_policy
from rl_x.algorithms.tqc_retrace.flax.critic import get_critic
from rl_x.algorithms.tqc_retrace.flax.entropy_coefficient import EntropyCoefficient, ConstantEntropyCoefficient
from rl_x.algorithms.tqc_retrace.flax.replay_buffer import ReplayBuffer
from rl_x.algorithms.tqc_retrace.flax.rl_train_state import RLTrainState
...
class TQC_Retrace():
    ...
    def load(config, env, run_path, writer):
        ...
        model = TQC_Retrace(config, env, run_path, writer)
