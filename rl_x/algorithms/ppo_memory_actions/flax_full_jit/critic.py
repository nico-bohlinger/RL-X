...
def get_critic(config, env):
    ...
    critic_observation_indices = jnp.concatenate([critic_observation_indices, jnp.arange(env.single_observation_space.shape[0], env.single_observation_space.shape[0] + config.algorithm.memory_action_dimension)])
