...
from rl_x.algorithms.vmpo.flax.policy import get_policy
from rl_x.algorithms.vmpo.flax.critic import get_critic
from rl_x.algorithms.vmpo.flax.agent_params import AgentParams
from rl_x.algorithms.vmpo.flax.storage import Storage
...
class VMPO:
    ...
    def load(config, env, run_path, writer):
        ...
        model = VMPO(config, env, run_path, writer)
