# Proximal Policy Optimization + Long Short-Term Memory

Contains the implementation of [Proximal Policy Optimization (PPO)](https://arxiv.org/abs/1707.06347) in combination with a [Long Short-Term Memory (LSTM)](https://www.bioinf.jku.at/publications/older/2604.pdf) for the policy network.
