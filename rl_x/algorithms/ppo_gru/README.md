# Proximal Policy Optimization + Gated Recurrent Unit

Contains the implementation of [Proximal Policy Optimization (PPO)](https://arxiv.org/abs/1707.06347) in combination with a [Gated Recurrent Unit (GRU)](https://arxiv.org/abs/1412.3555) for the policy network.
