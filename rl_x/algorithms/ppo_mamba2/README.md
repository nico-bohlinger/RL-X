# Proximal Policy Optimization + Mamba-2

Contains the implementation of [Proximal Policy Optimization (PPO)](https://arxiv.org/abs/1707.06347) in combination with a [Mamba-2](https://arxiv.org/pdf/2405.21060) for the policy network.
