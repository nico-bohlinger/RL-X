...
Contains RL-X Flax ports of [DIME](https://alrhub.github.io/dime-website/), an off-policy maximum-entropy algorithm whose actor is a time-reversed diffusion sampler trained with adjoint matching.
...
- NumPy-interface replay and update loop with the same adjoint-matching actor, distributional CrossQ critic, entropy temperature and samplewise update-to-data accounting
