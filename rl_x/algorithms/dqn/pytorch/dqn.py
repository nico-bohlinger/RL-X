...
from rl_x.algorithms.dqn.pytorch.critic import get_critic
from rl_x.algorithms.dqn.pytorch.replay_buffer import ReplayBuffer
...
class DQN:
    ...
    def load(config, train_env, eval_env, run_path, writer, explicitly_set_algorithm_params):
        ...
        model = DQN(config, train_env, eval_env, run_path, writer)
