...
- [```/rl_x/algorithms/near_ppo/```](https://github.com/nico-bohlinger/RL-X/blob/master/rl_x/algorithms/near_ppo/README.md): Implementation details of the Normalizing Adversarial Reward (NEAR) + Proximal Policy Optimization (NEAR+PPO) algorithm
