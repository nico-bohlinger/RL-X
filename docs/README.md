...
- [```/rl_x/environments/custom_mujoco/robot_locomotion/```](https://github.com/nico-bohlinger/RL-X/blob/master/rl_x/environments/custom_mujoco/robot_locomotion/README.md): Details on the robot locomotion MuJoCo and MJX environments, to train a quadruped (Unitree Go2 or MAB Silver Badger) or humanoid (Unitree G1) robot to walk
